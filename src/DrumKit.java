...
public class DrumKit extends MouseAdapter {
    ...
    private void getGoing() throws MalformedURLException {
    	...
    	drumWindow.setSize(1000, 600);
    	drumWindow.setTitle("Drum");
   	 JPanel drumOne = new JPanel();
   	 drumWindow.add(drumOne);
    ...
    String Snare=("Red-White-Blue-Snare-drum.jpg");
   	 // 9. Edit the next line to use your String variable
 drumLabelWithImage = createLabelImage(Snare);
   	 
   	 // 10. Add the image to the panel
    drumOne.add(drumLabelWithImage);
   	 // 11. Set the layout of the panel to "new GridLayout()"
    drumOne.setLayout(new GridLayout());
