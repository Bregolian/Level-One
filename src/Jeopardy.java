...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel panel=createHeader("Characters");
		JPanel panel2=createHeader("Spells");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed==firstButton) {
			askQuestion("What is the Minister of Magic's name in Book One?", "Cornelius Fudge",200);
		}
		else if (buttonPressed==secondButton) {
			askQuestion("What is Dumbledore's full name?", "Albus Percival Wulfric Brian Dumbledore",400);
		}
		else if (buttonPressed==thirdButton) {
			askQuestion("What is Ron's middle name?", "Billius",600);
		}
		else if (buttonPressed==fourthButton) {
			askQuestion("What is the disarming spell?", "Expelliarmus",200);
		}
